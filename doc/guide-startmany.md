...
[From the dstra github repo](https://github.com/dstra-crypto/dstra/blob/master/doc/masternode_conf.md)
...
## What about the dstra.conf file?

If you are using a masternode.conf file you no longer need the dstra.conf file. The exception is if you need custom settings (thanks oblox). 

## Update dstra.conf on server

If you generated a new masternode private key, you will need to update the remote dstra.conf files.

Shut down the daemon and then edit the file.

```sudo nano .dstra/dstra.conf```

### Edit the masternodeprivkey
If you generated a new masternode private key, you will need to update the masternodeprivkey value in your remote dstra.conf file.
...
And compare with the official explorer at http://dstraexplorer.coin-server.com <or> dnet.presstab.pw
