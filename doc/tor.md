...
```
./dstrad -onion=127.0.0.1:9050 -onlynet=tor -listen=0 -addnode=dnetzj6l4cvo2fxy.onion:989
```

In a typical situation, this suffices to run behind a Tor proxy:
```
./dstrad -proxy=127.0.0.1:9050
```
...
your dstrad's P2P listen port (51472 by default).
```
-externalip=X   You can tell dstra about its publicly reachable address using
                this option, and this can be a .onion address. Given the above
                configuration, you can find your onion address in
                /var/lib/tor/dstra-service/hostname. Onion addresses are given
...
```
./dstrad -proxy=127.0.0.1:9050 -externalip=dnetzj6l4cvo2fxy.onion:989 -listen
```
...
```
./dstrad -onion=127.0.0.1:9050 -externalip=dnetzj6l4cvo2fxy.onion:989 -discover
```
