...
//! These need to be macros, as clientversion.cpp's and dstra*-res.rc's voodoo requires it
...
/**
 * dstrad-res.rc includes this file, but it cannot cope with real c++ code.
