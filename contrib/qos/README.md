...
This means one can have an always-on dstrad instance running, and another local dstrad/dstra-qt instance which connects to this node and receives blocks from it.
