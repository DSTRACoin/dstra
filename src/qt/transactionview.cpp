                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Purified"), TransactionFilterProxy::TYPE(TransactionRecord::Obfuscated));
    typeWidget->addItem(tr("Purification Make Collateral Inputs"), TransactionFilterProxy::TYPE(TransactionRecord::PurificationMakeCollaterals));
    typeWidget->addItem(tr("Purification Create Denominations"), TransactionFilterProxy::TYPE(TransactionRecord::PurificationCreateDenominations));
    typeWidget->addItem(tr("Purification Denominate"), TransactionFilterProxy::TYPE(TransactionRecord::PurificationDenominate));
    typeWidget->addItem(tr("Purification Collateral Payment"), TransactionFilterProxy::TYPE(TransactionRecord::PurificationCollateralPayment));
