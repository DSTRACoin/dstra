...
In order to support loading of multiple wallets in dstra-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is dstra.cpp.
...
Changes to dstra.cpp
----------------------
dstra.cpp is the entry point into dstra-qt, and as such, will require some minor modifications to provide hooks for
