...
QString TransactionTableModel::formatTxType(const TransactionRecord* wtx) const
{
    ...
    case TransactionRecord::RecvWithPurification:
        return tr("Received via Purification");
    ...
    case TransactionRecord::Generated:
        return tr("Mined");
    case TransactionRecord::PurificationDenominate:
        return tr("Purification Denominate");
    case TransactionRecord::PurificationCollateralPayment:
        return tr("Purification Collateral Payment");
    case TransactionRecord::PurificationMakeCollaterals:
        return tr("Purification Make Collateral Inputs");
    case TransactionRecord::PurificationCreateDenominations:
        return tr("Purification Create Denominations");
