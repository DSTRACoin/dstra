                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("DSTRA Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a DSTRA address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and dstra: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About DSTRA Core"), this);
    aboutAction->setStatusTip(tr("Show information about DSTRA Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for DSTRA"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your DSTRA addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified DSTRA addresses"));
    ...
    openAction->setStatusTip(tr("Open a DSTRA: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the DSTRA Core help message to get a list with possible DSTRA command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("DSTRA Core client") + " " + networkStyle->getTitleAddText();
...
{
    QString strTitle = tr("DSTRA Core"); // default title
...
void BitcoinGUI::setStakingStatus()
{
    ...
    if (nLastCoinStakeSearchInterval) {
        ...
        labelStakingIcon->setToolTip(tr("Stake: Active (p=%1)\nMultiSend: %2").arg(dWalletStakePossibility).arg(fMultiSend ? tr("Active") : tr("Not Active")));
    } else {
        labelStakingIcon->show();
        labelStakingIcon->setPixmap(QIcon(":/icons/staking_inactive").pixmap(STATUSBAR_ICONSIZE, STATUSBAR_ICONSIZE));
        labelStakingIcon->setToolTip(tr("Stake: Not Active\nMultiSend: %1").arg(fMultiSend ? tr("Active") : tr("Not Active")));
    }
}
